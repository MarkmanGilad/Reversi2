...
file='Reversi/Data/DQN_Model_Fix_Rnd_Sigmoind.pth'
file_best='Reversi/Data/DQN_Model_best_Fix_Rnd_Sigmoind.pth'
fileRes = "Reversi/Data/Results_eval_Fix_Rnd_Sigmoind.pth"

# model = torch.load("Reversi/Data/DQN_Model_Fix_Rnd_Gamma.pth")
