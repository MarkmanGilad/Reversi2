...
model = DQN(env)
file='Data/DQN_Model_Fix_Rnd_Gamma.pth'
file_best='Data/DQN_Model_best_Fix_Rnd_Gamma.pth'
fileRes = "Data/Results_eval_Fix_Rnd_Gamma.pth"

model = torch.load("Data/DQN_Model_Fix_Rnd_Gamma.pth")
