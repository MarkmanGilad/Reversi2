...
model = DQN(env)
file='Reversi/Data/DQN_Model_Fix_Rnd_Gamma_S.pth'
file_best='Reversi/Data/DQN_Model_best_Fix_Rnd_Gamma_S.pth'
fileRes = "Reversi/Data/Results_eval_Fix_Rnd_Gamma_S.pth"

model = torch.load("Reversi/Data/DQN_Model_Fix_Rnd_Gamma_S.pth")
player1 = DQNAgent(model, player=1)
playerFix = FixAgent2(env, player=2, train=True)
player2 = playerFix
...
def main ():
    ...
    scheduler = StepLR(optim, step_size=1000, gamma=0.99)
